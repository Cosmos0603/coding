...
public:
    ...
    // might be.  For integral constants within a class, you can initialize
    // them where you declare them.  The reason we declared it "static" is
    // because it's a property of the class as a whole, as opposed to being
    // something that would separately need to be stored in every object
    // of this class.
    ...
    //
    //     Person* p = new Student("Alex Thornton", 37);
    //     delete p;
    //
